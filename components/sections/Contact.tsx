...
export default function Contact() {
  ...
  return (
    <section id="contact" className="w-full py-16 md:py-32 px-4 md:px-16 border-t border-hairline bg-bg-base" ref={containerRef}>
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 lg:gap-24">
        ...
        <div className="w-full md:w-1/3 contact-element">
          <header className="mb-8">
            <h2 className="font-display text-4xl md:text-6xl text-text-primary mb-4 md:mb-6 uppercase tracking-tighter">Get in Touch</h2>
